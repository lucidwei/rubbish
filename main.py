...
pipeline_optimizer = make_pipeline(
    ...
    StackingEstimator(estimator=GradientBoostingRegressor(alpha=0.8, learning_rate=0.01, loss="quantile", max_depth=4, max_features=0.1, min_samples_leaf=14, min_samples_split=18, n_estimators=100, subsample=0.15000000000000002)),
